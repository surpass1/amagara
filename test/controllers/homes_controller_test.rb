...
class HomesControllerTest < ActionController::TestCase
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post :create, home: { category: @home.category, description: @home.description, title: @home.title }
    end
  ...
  test "should update home" do
    patch :update, id: @home, home: { category: @home.category, description: @home.description, title: @home.title }
    assert_redirected_to home_path(assigns(:home))
  end
